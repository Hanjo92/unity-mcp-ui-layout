...
assert_contains "$mcp_doc" "target_surface" "MCP snapshot intake"
assert_contains "$mcp_doc" "unity_version_evidence" "MCP snapshot intake"
assert_contains "$mcp_doc" "selection.selected_object" "MCP snapshot intake"
assert_contains "$mcp_doc" "selection.active_ui_root" "MCP snapshot intake"
assert_contains "$review_doc" "target_surface" "review snapshot intake"
assert_contains "$review_doc" "unity_version_evidence" "review snapshot intake"
assert_contains "$review_doc" "selection.selected_object" "review snapshot intake"
assert_contains "$review_doc" "selection.active_ui_root" "review snapshot intake"
assert_contains "$mcp_doc" "ui-stack-selection.md" "UI Toolkit adjustment"
assert_contains "$mcp_doc" "decisive ownership evidence" "UI Toolkit adjustment"
assert_contains "$mcp_doc" "selected UIDocument" "UI Toolkit adjustment"
assert_contains "$mcp_doc" "resolved visual-tree root" "UI Toolkit adjustment"
assert_contains "$mcp_doc" "editor UI Toolkit owner" "UI Toolkit adjustment"
assert_contains "$mcp_doc" "before using UXML/USS assets" "UI Toolkit adjustment"
assert_contains "$mcp_doc" "mixed-stack project" "UI Toolkit adjustment"
assert_precedes "$mcp_doc" 'Start with `ui-stack-selection.md`' 'Identify the active `UIDocument`' "UI Toolkit adjustment"
